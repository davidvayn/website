...
const SEARCH_ALIASES: Record<string, string[]> = {
  ...
  fly: ["pokerfly", "flyvis", "flywire", "connectome", "neuroscience"],
  ...
  poker: ["holdem", "solver", "cfr", "expected value", "ev"],
  pokerfly: ["flyvis", "flywire", "connectome", "pytorch", "threejs"],
  connectome: ["pokerfly", "flyvis", "flywire", "neuroscience"],
  pytorch: ["machine learning", "neural network", "pokerfly"],
